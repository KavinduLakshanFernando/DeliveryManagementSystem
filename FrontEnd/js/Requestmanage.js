const fetchRequestData = () => {
    $.ajax({
        ...
        method: "GET",
        success: (res) => {
            // Empty the existing content in requestTableBody
...
// Call function to fetch request data
fetchRequestData();

// Handle Active & DeActive button clicks
// Handle Active & DeActive button clicks
...
// Handle View button click to show popup
